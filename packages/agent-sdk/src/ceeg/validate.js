...
// Mirrors scripts/tea/validate.mjs to keep a single source of truth.
export function validateErq(erq) {
  ...
  if (typeof erq?.network_required !== 'boolean') errors.push(err('ERQ_INVALID', 'network_required must be boolean'));
