# AGENT-BOARD — Sub-agent Oversight (STRICT)
...
- Task is research-heavy (docs, API behavior, comparisons).
- Task benefits from a second opinion (security, permissions, schema, migration risk).
- Task is long-running / multi-step and can be isolated cleanly.
...
- Evidence & Deliverables (paths, commands, links)
- Risks / Unknowns
- Next 3 actions
- Questions for Conductor (only if blocked)
