...
- [ ] **PMS-D-01** — MVP demo script finalization + acceptance checklist  
  ...
  - Priority: P0  
  - Owner: Jordan + Aden  
  - DoD: Single runbook + acceptance list + fallback plan; dry run <15 min.
...
- [ ] **PMS-A-03** — Inspection → estimate demo path hardening  
  ...
  - Priority: P0  
  - Owner: Aden  
  - QA focus: happy path, forced-failure fallback path, standardized output block (Scope/Cost/Timeline/Confidence/Rationale).  
